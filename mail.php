...
$fromName = "Deepti Publications";
        ...
        $mail = new phpmailer();
	$mail->From = "info@dporderform.com";
	$mail->FromName = "Deepti Publications";
	$mail->AddReplyTo($replyEmail,$fromName);  //this is email2@example.com
	...
	$mail->IsSMTP(); // enable SMTP
        ...
        $mail->Password = "dkmsvxhnzzmhhyso"; 
	$mail->From = "india2sree@gmail.com";
	$mail->FromName = "Deepti Publications";
	$mail->IsHTML(true);
	$mail->Subject = "Deepti Publications $statename Order Form - $ran ";
	$mail->Body = $message;
...
$messagecontent = "Testing Mail"; //Type Of Your Message
