...
<title>Deepti Publications View Order Form</title>
...
<header class="container-fluid">
    ...
    <div class="col-md-6 text-left">
      <h2  style="color: #2e3289;">View Bulk Order Form</h2></div>
    </div>
    ...
    <td align="left" class="cart-txt" style="font-size:12px"><font class="cart-txt ">
      ...
      <table width="100%" align="center"  cellspacing="" class="contable">
        ...
        <td colspan="4"><span class="colorstar">*</span>College Name on Cover Page of Study Materials Required :  
          <input type="radio" name="board" disabled value="yes" <?php if($address['6'] == 'yes'){ ?>checked<?php } ?>> Yes 
  <input type="radio" name="board" value="no" disabled <?php if($address['6'] == 'no'){ ?>checked<?php } ?>> No        </td>
