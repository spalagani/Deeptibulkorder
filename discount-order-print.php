...
<head>
<meta charset="UTF-8">
<title>Deepti Publications Discount Order Print</title>
...
?>
  ...
  <tr>
    <td width="750" align="center" valign="middle" class="title_txt" background="images/long_bar1.jpg" height="26" ><strong stlye="font-size:18px"><?php echo $sorders['c_name'] ?>&nbsp;Discount Order Print </strong></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	?>
      <tr>
		...
		?>          </td>
        <td  class="accttrd" align="center " style="font-size:10px"><?php echo $det['new_price'] ?></td>
        <td   class="accttrd" align="center" style="font-size:10px"><?php echo $pro[1] ?></td>
        <td   class="accttrd" align="center" style="font-size:10px"><?php echo $pro[2] ?></td>
        <td   class="accttrd" align="center" style="font-size:10px">
